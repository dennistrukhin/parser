...
class Tokenizer {
    enum TokenizerState {S_READY, S_IDENTIFIER, S_STRING, S_NUMBER_INT, S_NUMBER_FLOAT, S_EQUALITY};
    enum Token {T_IDENTIFIER, T_STRING, T_INTEGER, T_FLOAT,
...
private:
    ...
    void add_token_operator(Token t, const std::string& s);
